 ...
 * @see
 */
@GroupSequenceProvider(CreateReady4CriteriaFormServiceTask.Ready4CriteriaFormServiceTaskVOProvider.class)
public class CreateReady4CriteriaFormServiceTask {
    ...
    public static final class Ready4CriteriaFormServiceTaskVOProvider implements DefaultGroupSequenceProvider<CreateReady4CriteriaFormServiceTask> {

        @Override
        public List<Class<?>> getValidationGroups(CreateReady4CriteriaFormServiceTask serviceTaskVO) {
            ArrayList<Class<?>> list = new ArrayList<>(2);
            list.add(CreateReady4CriteriaFormServiceTask.class);
