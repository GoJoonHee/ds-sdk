 ...
 * @see
 */
@GroupSequenceProvider(CreateFlowNode.CreateFlowNodeProvider.class)
public class CreateFlowNode {
    ...
    @NotBlank
    @InEnumClass(value = FlowNodeType.class, field = "code")
    ...
    private List<@Valid CreateAbstractSchemaServiceTask> customProperties;
    ...
    public List<CreateAbstractSchemaServiceTask> getCustomProperties() {
        return customProperties;
    }

    public void setCustomProperties(List<CreateAbstractSchemaServiceTask> customProperties) {
        this.customProperties = customProperties;
    }

    public static final class CreateFlowNodeProvider implements DefaultGroupSequenceProvider<CreateFlowNode> {

        @Override
        public List<Class<?>> getValidationGroups(CreateFlowNode flowNode) {
            ArrayList<Class<?>> list = new ArrayList<>(4);
            list.add(CreateFlowNode.class);
            if (flowNode != null) {
