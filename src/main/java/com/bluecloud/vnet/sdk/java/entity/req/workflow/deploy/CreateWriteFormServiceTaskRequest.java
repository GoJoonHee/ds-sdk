 ...
 * @see
 */
@GroupSequenceProvider(CreateWriteFormServiceTaskRequest.WriteFormServiceTaskVOProvider.class)
public class CreateWriteFormServiceTaskRequest extends CreateAbstractSchemaServiceTaskRequest {
    ...
    public static final class WriteFormServiceTaskVOProvider implements DefaultGroupSequenceProvider<CreateWriteFormServiceTaskRequest> {
        @Override
        public List<Class<?>> getValidationGroups(CreateWriteFormServiceTaskRequest serviceTaskVO) {
            ArrayList<Class<?>> list = new ArrayList<>(2);
            list.add(CreateWriteFormServiceTaskRequest.class);
